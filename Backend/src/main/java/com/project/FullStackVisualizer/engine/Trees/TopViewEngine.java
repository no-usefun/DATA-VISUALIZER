...
@Component
public class TopViewEngine extends TreeEngineSupport implements AlgorithmEngine {
    ...
    public List<Step> generateStep(ExecutionRequest request) {
        ...
        Map<Integer, TreeNode> topNodes = new HashMap<>();
        ...
        while (!queue.isEmpty()) {
            ...
            topNodes.putIfAbsent(distance, node);
